      ...
      <section className="grid flex-1 items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="brutal-card bg-[#ff5fb7] p-6 md:p-10">
          ...
          <p className="mt-6 max-w-2xl text-xl font-bold leading-relaxed">
            Next.js cân frontend/backend, Neon Postgres giữ dữ liệu, session
            bằng fingerprint + UUID + JWT HttpOnly Cookie.
          </p>
          <div className="mt-8 grid gap-3 text-base font-black md:grid-cols-3">
            <div className="border-[3px] border-black bg-[#7dff7a] p-3 shadow-[4px_4px_0_#111]">
              Fingerprint
            </div>
            <div className="border-[3px] border-black bg-[#5dc9ff] p-3 shadow-[4px_4px_0_#111]">
              Device UUID
            </div>
            <div className="border-[3px] border-black bg-[#ff9f1c] p-3 shadow-[4px_4px_0_#111]">
              Neon DB
            </div>
          </div>
        </div>
